...
class CustomPwdFormFieldDark extends StatefulWidget {
  ...
  @override
  State<CustomPwdFormFieldDark> createState() => _CustomPwdFormFieldDarkState();
}

class _CustomPwdFormFieldDarkState extends State<CustomPwdFormFieldDark> {
