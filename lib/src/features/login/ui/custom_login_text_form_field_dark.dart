...
class CustomLoginTextFormFieldDark extends StatefulWidget {
  ...
  @override
  State<CustomLoginTextFormFieldDark> createState() =>
      _CustomLoginTextFormFieldDarkState();
}

class _CustomLoginTextFormFieldDarkState
    extends State<CustomLoginTextFormFieldDark> {
  @override
  void initState() {
    super.initState();
    //
